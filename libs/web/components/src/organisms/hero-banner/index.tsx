  ...
  const heroSlider: TSliderProps[] = [
    {
      sliderSection: (
        <header
          className={`bg-center ${backgrounColor} flex justify-center items-center bg-fixed bg-cover lg:w-full xl:h-screen h-auto relative w-screen bg-no-repeat bg-blend-overlay`}
          style={{
