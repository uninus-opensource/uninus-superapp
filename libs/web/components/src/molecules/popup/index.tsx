  ...
  return (
    showPopUp && (
      <motion.section
        ...
        className={`flex w-[70vw] sm:w-[20rem] lg:w-[23rem] flex-col justify-center items-center h-60 z-50 ${position} bg-primary-white transition-transform rounded-lg shadow-md duration-0`}
      >
        {/* header */}
