...
export const UploadField: FC<TUploadFile> = (props): ReactElement => {
  ...
  const inputFileVariants = clsx(
    ...
    {
      "file:p-2": props.variant === "default",
    ...
    <div className={props.className}>
      ...
      {props.variant === "default" ? (
        ...
        <>
          ...
          <label
            htmlFor="files"
            className="px-1 py-2 bg-primary-green text-md font- w-[59vw] md:w-[29vw] lg:w-[22vw] 2xl:w-[18vw] xl:w-full cursor-pointer text-primary-white text-center rounded z-10"
          >
            Choose File
          </label>
        </>
