            ...
            <SelectOption
              ...
              options={
                occupationOptions?.filter(
                  (occupation) => occupation.label !== "Ibu Rumah Tangga",
                ) || []
              }
              className="w-full md:w-[33vw] lg:w-[27vw] xl:w-[25vw]"
              isSearchable={true}
            ...
            <SelectOption
              ...
              placeholder={
                student?.parent_city_id
                  ? cityOptionsParent?.find(
                      (city) => Number(city.value) === student?.parent_city_id,
                    )?.label
                  : "Kota/Kabupaten"
              }
              isSearchable={true}
              ...
              <section className="flex flex-wrap w-full justify-center items-start gap-x-1 lg:flex  lg:flex-wrap lg:gap-6 xl:gap-1 gap-y-4 mt-2 lg:items-center lg:w-55% md:flex md:flex-wrap md:w-80% md:justify-between">
                <div className="w-80% px-5 flex flex-col gap-y-4 md:flex md:flex-row md:w-full md:px-0 md:justify-between">
                  ...
                  <SelectOption
                    ...
                    isClearable={true}
                    disabled={
                      isSubmitted || !!student?.guardian_status_id || !!student?.mother_name
                    }
                  />
                </div>
                <div className="w-80% px-5 flex flex-col gap-y-4 md:flex md:flex-row md:w-full md:px-0 md:justify-between">
