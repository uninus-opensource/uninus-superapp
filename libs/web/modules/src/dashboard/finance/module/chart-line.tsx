...
export const ChartRekap: FC = (): ReactElement => {
  ...
  switch (chartType) {
    case "tahunan":
      ...
      totalRegistrations = paymentSummaryData?.summary?.total_student as unknown as [];
      unpaids = paymentSummaryData?.summary?.undone_payment as unknown as [];
      paids = paymentSummaryData?.summary?.paids as unknown as [];
      receiveds = paymentSummaryData?.summary?.additions_paids as unknown as [];
      break;
    case "bulanan":
      labels = [
        "Januari",
