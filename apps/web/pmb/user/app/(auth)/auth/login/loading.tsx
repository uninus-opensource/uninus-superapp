export default function Loading() {
  return (
    <section className="w-full bg-primary-white z-50 py-8">
      {/* Head */}
      <section className="w-full h-fit flex items-start md:flex animate-pulse my-4 justify-center  ">
        <div className="flex flex-col  gap-x-4 mt-6 xl:mt-0 md:mx-auto lg:w-[90%] w-full">
          <div className="flex mb-5 md:mb-1 lg:ml-4 flex-col items-center gap-2 xl:gap-0 lg:items-start lg:mt-6 md:justify-center justify-center">
            <span className="bg-grayscale-2 w-[4rem] lg:mb-0 xl:mb-1  md:h-5 h-7 xl:w-[9rem] rounded-lg xl:h-10"></span>
          ...
          <div className=" flex flex-col items-center lg:items-center justify-center mt-5 lg:mb-3 xl:mt-1 gap-y-1 lg:mt-2  lg:flex-nowrap lg:gap-1 md:gap-y-1 ">
            <span className="items1 self-start ml-8 lg:ml-4 bg-grayscale-2 mb-2 lg:mb-0 xl:mb-3 w-[27%] md:w-[20%] lg:w-[5rem] h-5 rounded-lg"></span>
            <span className="bg-grayscale-2 w-[90%] h-8  xl:h-9 rounded-lg"></span>
          </div>
